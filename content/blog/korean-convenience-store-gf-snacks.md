...
Before any list of what works, set expectations. The categories that look like a quick meal are the ones that fail hardest:

- **컵라면 / 라면 (instant noodles)** — wheat noodles, essentially always
- **샌드위치 (sandwiches)** — bread
- **삼각김밥 (triangle kimbap)** — the rice itself is usually fine, but many fillings carry soy sauce or wheat-based seasoning
- **도시락 (lunch boxes)** — sauces, marinades, fried components
- **핫바 / 어묵 (fish cake bars)** — almost always bound with wheat starch

To put a number on that, in **April 2026** I pulled CU's online 간편식사 catalog — **211 items** (도시락, 삼각김밥, 김밥, sandwiches, salads, burgers, noodles, 주먹밥, breakfast items) — and sorted every one of them.

**Be clear about what that was:** a keyword pass over *product names and categories*. CU's listing doesn't publish ingredient panels, so I never saw an 원재료명 list. It can flag what's obviously wheat; it cannot clear anything.

With that caveat, the shape was still blunt. Nothing came back gluten-free — which a name-based pass could never establish anyway — and the distribution was: **81 wheat by name or category** (every sandwich, burger, noodle and 겟모닝 breakfast item, plus 돈까스 / 만두 / 핫도그 / 멘보샤 / 파스타 / 카레), **39 risky**, **75 undetermined**, and **16 with no obvious gluten signal in the name** (참치마요, 명란, 계란 items).

The category rule over-flags in the other direction, too: it stamped four rice 꼬마김밥 as wheat purely for sitting in the breakfast aisle.

Even that last bucket isn't clean. One of the 16 was a **soy-sauce-braised egg** (반숙계란장) — soy sauce is wheat, and my keyword list missed it because the string didn't contain 간장. That single miss is the honest summary of this whole exercise: *a name can't tell you what's in a package.* This was CU's web catalog only, in one season — GS25, 7-Eleven and Emart24 use different suppliers, and SKUs rotate faster than my spreadsheet does.

## Gluten-free Korean snacks that pass: potato, corn, rice
...
This is the most important thing on this page, and the reason a brand name is never enough:

| Snack | Reported wheat-free | Reported to contain wheat |
|---|---|---|
| 포카칩 Pocachip | **Original** | **Onion flavor** |
| 도리토스 Doritos | **Cheese** | other flavors — check each |
| 사또밥 Sattobap | **Corn (옥수수)** | other flavors — check each |
...
Flavor lineups rotate and recipes get reformulated without announcement, so **check the specific package, every time.** The four-word scan (밀 / 소맥 / 보리 / 호밀) from our [label-reading guide](/blog/reading-korean-food-labels) takes about two seconds once it's a reflex.

## The traps that aren't in the snack aisle
...
And a caution that applies to every list like this, mine included: **Korean formulations change**, and much of what circulates in gluten-free communities — including the roundup this page draws on — is second-hand and undated. That's why I've dated everything here. Use the patterns to know what's worth flipping over; let the label make the final call.

## What to do with this

1. **Shop the snack aisle, not the fridge.** Fresh food is where the wheat is.
2. **Think base ingredient:** potato, corn, rice = worth checking. Flour-shaped = skip.
3. **Never trust a brand, only a package** — the flavor trap is the most common way people get caught.
4. **Remember the cooler:** 보리차 is barley.
5. **If you're celiac,** read the full ingredient list rather than just the allergen line, and assume shared facilities unless told otherwise.

## Related guides

- [The Real Gluten-Free Guide to Korea](/blog/celiac-travel-korea-guide) — start here
- [How to Read Korean Food Labels for Gluten](/blog/reading-korean-food-labels) — the two-second scan this page depends on
- [The Hidden Gluten in Korean Food](/blog/hidden-gluten-korean-food) — why soy sauce and seasoning are the real danger
- [Butter Tteok: An Accidentally Gluten-Free Korean Dessert](/blog/gluten-free-butter-tteok) — when you want better than chips
