...
- 2026-08-16 인스타 오배포: 이미지 HTTP 200만 확인하고 **내용을 보지 않은 채** 게시 → 8월에 "Christmas 2024" 배너가 썸네일로 나감. **외부 발행(SNS·배포) 전에는 산출물을 실제로 열어서 확인할 것.** 200은 "파일이 있다"이지 "맞는 파일이다"가 아니다.
- 2026-08-16 게이트 제거 금지: "cover가 없으면 건너뛴다"로 고친 것이 사고의 직접 원인. **어떤 리소스의 부재가 왜 있는지 모를 때, 그것을 없어도 되는 것으로 취급하지 말 것** — 부재 자체가 준비 미완 신호일 수 있다.
